...
export const Hero = () => {
  return (
    ...
    >
      ...
      {/* Start Ring 1 */}
      <div className="absolute w-[344px] h-[344px] md:h-[580px] md:w-[580px] opacity-20 rounded-full border border-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
      ...
      {/* Start Ring 2 */}
      <div className="absolute h-[444px] w-[444px] md:h-[780px] md:w-[780px] rounded-full border border-white/20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-dashed" />
      {/* End Ring 2 */}
